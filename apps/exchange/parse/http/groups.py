...
from apps.exchange.parse.http.base import Counter
...
class AllGroupsParser(BaseHttpParser):
    ...
    def parse(self):
        ...
        self.logger.info('Educational levels created: %d', self.level_counter.created)
        self.logger.info('Educational levels updated: %d', self.level_counter.updated)
